//===============================================
//Archivo: main_ecuaciones3det_template.cc
//===============================================
...
#include "determinante3x3_template.h"
#include "ecuaciones3incog_template.h"
...
/*
  EcuLin3[0][0]=_complex(1,5);
  EcuLin3[0][1]=_complex(1,-5);
  EcuLin3[0][2]=_complex(1,2);
  EcuLin3[0][3]=_complex(6,2);

  EcuLin3[1][0]=_complex(2,4);
  EcuLin3[1][1]=_complex(-1,3);
  EcuLin3[1][2]=_complex(1,2);
  EcuLin3[1][3]=_complex(3,5);

  EcuLin3[2][0]=_complex(1);
  EcuLin3[2][1]=_complex(-1);
  EcuLin3[2][2]=_complex(1);
  EcuLin3[2][3]=_complex(2);
*/
  if (EcuLin3.resolver())
  {
