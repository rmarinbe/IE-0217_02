...
{
	for (int i=0; i < (int)infixExpression.length(); i++)
	{
		...
		switch(ch)
		{
          ...
          case '7':
          case '8':
          case '9': t_infixExpression.push(token_numero);
                    val=ch-'0';
                    infixExpressionData.push(val);
                    break;
